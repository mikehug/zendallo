...
class CustomizedDot extends Component { // eslint-disable-line
  render() {
    const {
      cx, cy, value,
    } = this.props;
    ...
    if (value > 2500) {
      return (
        <svg x={cx - 10} y={cy - 10} width={20} height={20} fill={green[400]} viewBox="0 0 1024 1024">
    ...
    return (
      <svg x={cx - 10} y={cy - 10} width={20} height={20} fill={red[400]} viewBox="0 0 1024 1024">
