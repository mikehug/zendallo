...
class Practice extends React.Component {
  ...
  getLessonComponent = (lessons) => {
    ...
    switch (content.type) {
      ...
      case 'activity':
        return <Activity data={content.data} nextLesson={this.handleNext} storeResult={this.storeResult} id={this.state.activeStep} handleOnClickAlert={this.handleOnClickAlert} />;
      default:
  ...
  render() {
    ...
    return (
      <Grid container className={classes.root} justify="space-between" spacing={0} direction="column">
        <Grid item>
          <Divider />
          <MobileStepper
            type="dots"
