    ...
    <Grid item xs={10} sm={8} md={7} lg={6} className={classes.col}>
      ...
      <Paper className={classes.paper}>
        ...
        <Typography variant="subheading" className={classes.font}>
          Have more efficient and effective meetings with agenda collaboration
          and attendee profile sharing.
        </Typography>
        ...
        <Typography variant="subheading" className={classes.font}>
          Gain visibility into the entire teams perspective using a virtual team
          radar of opinions and perspectives
        </Typography>
